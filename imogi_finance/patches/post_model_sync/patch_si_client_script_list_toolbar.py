"""Call Sales Invoice list toolbar from Client Script (runs after __custom_list_js)."""
...
def execute():
	for row in frappe.get_all(
		...
		if "init_sales_invoice_list_toolbar" in script:
			continue
		...
		if not replaced:
			frappe.log_error(
				title="patch_si_client_script_list_toolbar",
