// Loaded via app_include_js + doctype form script. Guard avoids double-register.
if (!window.__imogi_bank_statement_form_loaded) {
	window.__imogi_bank_statement_form_loaded = true;
